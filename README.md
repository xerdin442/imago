...
- **Wager Management**: Creation and joining of head-to-head wagers on any topic of choice across diverse categories. Also features a marketplace to explore wagers created by other users.
...
- **Stablecoin Integration**: USDC deposits and withdrawals (on Base and Solana); this means that anyone can wager on Imago from anywhere in the world.
...
- **Domain Names**: Support for Basenames and SNS domains in withdrawals.
